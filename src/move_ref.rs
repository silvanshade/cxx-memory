...
mod test {
    ...
    fn deref_move_of_move_ref() {
        let_cxx!(x: MoveRef<crate::Box<i32>> = &move crate::Box::new(5));
        let_cxx!(y: MoveRef<crate::Box<i32>> = &move *x);
        let z = y;
        assert_eq!(**z, 5);
    }
